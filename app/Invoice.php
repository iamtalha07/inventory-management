...
class Invoice extends Model
{
    ...
    {
        return $this->belongsToMany(Product::class,'invoice_product')->withTrashed()->withPivot('qty','ctn_qty','disc_by_cash','disc_by_percentage','amount','disc_amount','product_type','unit_price','ctn_price');
    }
