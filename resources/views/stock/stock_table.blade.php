        ...
        <tbody tbody id="leadsTable">
            @foreach ($data as $item)
                <tr>
                    ...
                    <td>
                        <a title="Manage quantity" href="javascript:void(0)" id="{{ $item->id }}"
                            class="addQtyClass"><i class="fas fa-plus"></i></a>&nbsp &nbsp
                    </td>
                </tr>
            @endforeach
        </tbody>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="qtyRadio1" name="qtyOption"
                                value="returned-quantity" checked>
                            <label for="qtyRadio1" class="custom-control-label">Returned Quantity</label>
                        </div>
                        <div class="custom-control custom-radio">
                            <input class="custom-control-input" type="radio" id="qtyRadio2" name="qtyOption"
                                value="add-quantity">
