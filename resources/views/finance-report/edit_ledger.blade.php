            ...
            <form method="POST" action="{{ url('update-ledger', ['id' => $account->id]) }}">
                ...
                <div class="card card-info">
                    <div class="card-header">
                        <h3 class="card-title">Edit Finance Ledger</h3>
                        ...
                        <div class="row">
                            <div class="col-3">
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="brand_id">
                                    ...
                                    <option value="{{$brand->id}}" selected="{{ $account->brand_id }}">{{ $brand->name }}</option>
                                    @endforeach
                                  </select>
                                </div>
                            </div>
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="products" value="{{ $account->product_name }}" class="form-control"
                                ...
                                <div class="form-group">
                                    <label>Bill Date:</label>
                                      <div class="input-group date" id="reservationdate" data-target-input="nearest">
                                          <input type="text" name="bill_date" value="{{ $account->bill_date }}" placeholder="Enter Date" class="form-control datetimepicker-input" data-target="#reservationdate"/>
                        ...
                        <div class="row">
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="total_amount" id="total_amount" value="{{ $account->total_amount }}" class="form-control"
                            ...
                            <div class="col-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="amount_remaining" id="amount_remaining" value="{{ $account->amount_paid }}" class="form-control"
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="payable_by" value="{{ $account->payable_by }}" class="form-control"
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="payable_to" value="{{ $account->payable_to }}" class="form-control"
